        ...
        if(mysqli_connect_errno()){
            ...
            if (isset($_SESSION['adminuser']) && isset($_SESSION['from'])){ 
                ...
                if($_SESSION['from'] == "tor"){
                    ...
                    mysqli_query($con, "update tor set toraccess = '" . $acs . "' where stud_id = '" . $_POST['stud_id'] . "'");
                }
                else if($_SESSION['from'] == "repcard"){
                    $action = "studentrepcard.php";
                    mysqli_query($con, "update reportcard set repcardaccess = '" . $acs . "' where stud_id = '" . $_POST['stud_id'] . "'");
                }
                else if($_SESSION['from'] == "diploma"){
                    $action = "studentdip.php";
                    mysqli_query($con, "update diploma set dipaccess = '" . $acs . "' where stud_id = '" . $_POST['stud_id'] . "'");
                }
                else if($_SESSION['from'] == "asr"){
                    $action = "studentasr.php";
                    mysqli_query($con, "update asr set asraccess = '" . $acs . "' where stud_id = '" . $_POST['stud_id'] . "'");
                }
