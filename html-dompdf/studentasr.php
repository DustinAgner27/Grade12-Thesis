...
<h1 style="margin-bottom: -7vh"> <?php echo $_POST['name'] ?>'s ASR </h1><br>
  <div class="back">
		<?php
			$back = "window.location='asr.php'";
...
<div class="container mt-5">
    <div class="row">
		...
		<?php 
			...
			$filepat = "asr/asr" . $_POST['stud_id'] .".pdf";
			echo $filepat;

			if(file_exists($filepat)){
				mysqli_query($con, "update asr set asrfile = '" . $filepat . "' where stud_id = '" . $stud_id . "'");
		...
		<form action="upload_file.php" method="POST" enctype="multipart/form-data">
			...
			<input type="hidden" name = "filepat" value = "<?php echo "asr/asr" . $_POST['stud_id'] . ".pdf";?>">
		...
		<form action="access.php" method="POST">
			...
			<input type="hidden" name = "stud_id" value = "<?php echo $_POST['stud_id'];?>">
			<input type="hidden" name = "name" value = "<?php echo $_POST['name'];?>">
			<input type="radio" name="acs" value="1" <?php if($data['asraccess'] == 1){ echo "checked"; }?>><label> YES </label>
			<input type="radio" name="acs" value="0" <?php if($data['asraccess'] == 0){ echo "checked"; }?>><label> NO </label>
